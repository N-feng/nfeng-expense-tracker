...
export const CardFooter: React.FC<CardFooterProps> = ({
  ...
  return (
    <View style={[styles.footer, getAlignmentStyle(), style]}>{children}</View>
  );
};
...
export const InfoCard: React.FC<InfoCardProps> = ({
  ...
  <Card {...cardProps}>
    <CardHeader title={title} subtitle={subtitle} rightElement={rightElement} />
    {description && (
      <CardBody>
  ...
  <Card {...cardProps}>
    ...
    <CardBody style={styles.listBody}>
      {items.map((item, index) => (
        ...
        >
          {item.icon && <View style={styles.listItemIcon}>{item.icon}</View>}
